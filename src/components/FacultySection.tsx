  ...
  const faculty = [
    {
      ...
      experience: "15+ years",
      achievements: ["Best Faculty Award 2023", "Research Excellence Award", "Published 50+ Research Papers"],
    ...
    },
    {
      ...
      experience: "12+ years",
      achievements: ["Industry Collaboration Award", "Student Mentor of the Year", "Google Cloud Certified"],
    ...
    },
    {
      ...
      experience: "8+ years",
      achievements: ["Young Researcher Award", "App Development Specialist", "Design Thinking Expert"],
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Meet the brilliant minds who guide and mentor our club members towards excellence
          </p>
        </div>
              ...
              <CardContent className="p-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <p className="font-semibold text-sm text-foreground">Specialization</p>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <p className="font-semibold text-sm text-foreground mb-2">Achievements</p>
