...
export function Footer() {
  ...
  const contactInfo = [
    { icon: Mail, text: "graphicgeeks@geu.ac.in", href: "mailto:graphicgeeks@geu.ac.in" },
  ...
  return (
    <footer id="join" className="bg-gradient-to-br from-primary/5 via-background to-accent/5 border-t">
      {/* Join Section */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div>
            ...
            <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
              Become part of an amazing community of tech enthusiasts, innovators, and future leaders. 
              Start your journey with Graphic Geeks today!
            </p>
          ...
          <div className="flex justify-center">
            <Card className="glass-card hover:glow-effect transition-all duration-300 max-w-sm w-full">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-2xl font-bold mb-4 text-foreground">Quick Join</h3>
                ...
                <p className="text-muted-foreground text-sm">
                  Scan this QR code with your phone to join our WhatsApp group and get instant updates!
                </p>
              </CardContent>
            </Card>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <p className="text-muted-foreground mb-6 leading-relaxed">
              Empowering students with cutting-edge technology skills and fostering innovation 
              at Graphic Era University.
            </p>
            <div className="flex items-center space-x-2">
              <img src={collegeLogo} alt="Graphic Era College" className="h-8 w-8" />
              <span className="text-sm text-muted-foreground">Graphic Era University</span>
            </div>
          </div>
